...
function main()
{
	/*copy the main file to a save place
	main file is any file over 50mb
	rename according to:
		1) split on the year date (test that it is there first)
		2) drop everything after year, except extention
		3) clear all special characters with a space (just period?)
		4) put the year in parens
		5) move to movie folder
		6) move to tenda
		7) copy to plex via FTP?
	*/
